...
fn build_user_prompt(template: &str, ind: &GridIndicators, bot: &crate::models::GridBot) -> String {
    ...
    template
        ...
        .replace("{h1_bb_width_pct}", &format!("{:.2}", ind.bb_width * 100.0))
        ...
        .replace("{h1_bandwidth_5bars_ago}", &format!("{:.2}", ind.h1_bandwidth_5bars_ago * 100.0))
        ...
        .replace("{m15_bb_width_pct}", &format!("{:.2}", ind.m15_bb_width_pct * 100.0))
        ...
        .replace("{h4_bb_width_pct}", &format!("{:.2}", ind.h4_bb_width_pct * 100.0))
