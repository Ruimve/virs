...
|------|---------|------|---------|---------|
| 1 | `w1_1_position_all_fields` | 仓位转 WS JSON 全字段 | side=Long, status=Open, entry_price=50000.0, stop_loss=45000.0, take_profit=55000.0 | type=position_updated, symbol=BTC/USDT, side=long, status=open, quantity=1.0, entry_price=50000.0, stop_loss=45000.0, take_profit=55000.0 |
...
| 4 | `w2_1_kline_normal` | K 线事件转 WS JSON 正常字段 | KlineEvent: exchange=binance, symbol=BTC/USDT, timeframe=1m, candle.open=50000.0, close=50100.0, closed=false, event_type=Update | exchange=binance, symbol=BTC/USDT, timeframe=1m, candle.open=50000.0, candle.close=50100.0, candle.closed=false, event_type=Update |
...
| 7 | `w3_1_orderbook_normal` | 订单簿事件转 WS JSON 正常 | 2 档买盘和 2 档卖盘, 首档 price=50000.0, amount=1.5 | exchange=binance, symbol=BTC/USDT, bids 长度=2, asks 长度=2, bids[0]=[50000.0, 1.5] |
...
| 3 | `int_2_1_position_serde_then_ws_json` | 仓位序列化后转 WS JSON 链路 | side=Long 仓位, stop_loss/take_profit=None | json type=position_updated, symbol=BTC/USDT, side=long, 序列化字符串含 "position_updated" |
