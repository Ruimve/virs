...
pub fn build_router(state: AppState) -> Router {
    Router::new()
        ...
        .route("/api/credentials/test", post(handlers::credentials::test_credential))
        // Dashboard
        ...
        .route("/api/ai-credentials/test", post(handlers::ai_credentials::test_credential))
        // Grid Bot
        ...
        .route("/api/paper/status", get(handlers::grid::paper_status))
        .route("/api/paper/enable", post(handlers::grid::paper_enable))
        .route("/api/paper/disable", post(handlers::grid::paper_disable))
