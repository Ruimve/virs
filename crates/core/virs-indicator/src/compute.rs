...
pub fn default_specs() -> Vec<IndicatorSpec> {
    ...
    vec![
        ...
        BbandsUpper { tf: M15, period: 20, stddev: 2 },
        BbandsMiddle { tf: M15, period: 20, stddev: 2 },
        BbandsLower { tf: M15, period: 20, stddev: 2 },
        ChangePct { tf: M15, period: 1 },
        CandleBody { tf: M15 },
        Highest { tf: M15, period: 20 },
        Lowest { tf: M15, period: 20 },
        BandwidthBarsAgo { tf: M15, period: 20, stddev: 2, bars_ago: 5 },
        EmaGapPct { tf: M15, fast: 20, slow: 50 },
