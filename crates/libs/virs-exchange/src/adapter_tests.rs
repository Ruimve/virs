...
fn a4_1_kline_normal_conversion() {
    ...
    // close_time = timestamp + 60000 (1m interval)
    assert_eq!(kline.close_time, 1700000000000 + 60_000);
}
...
fn a4_2_kline_exchange_field() {
    ...
    // close_time = timestamp + 3_600_000 (1h interval)
    assert_eq!(kline.close_time, 100 + 3_600_000);
}
